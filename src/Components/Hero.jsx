...
const Hero = () => {
  ...
  return (
    <section className="relative pt-20" style={{ minHeight: "100vh" }}>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <div className="flex space-x-4">
              ...
              <button
                className={`px-6 py-3 rounded-lg font-medium border-2 border-emerald-600 transition-colors !rounded-button whitespace-nowrap cursor-pointer ${
                  darkMode
          ...
          <div className="md:w-1/2 md:pl-10">
            ...
            >
              <h3 className="text-xl font-bold mb-4">কুইক প্যাকেজ ফাইন্ডার</h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex space-x-2">
                    <button
                      className={`flex-1 py-2 px-4 rounded-lg border !rounded-button whitespace-nowrap cursor-pointer ${
                        darkMode
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                      <input
                        type="date"
                        className={`w-full p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 border-none ${
                          darkMode ? "bg-gray-700" : "bg-white"
                        }`}
                      />
                    </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <button className="p-2 rounded-l-lg border !rounded-button whitespace-nowrap cursor-pointer">
                      <FaMinus />
                    </button>
                    <input
                      type="text"
                      value="2"
                      className={`w-full p-3 text-center border-t border-b focus:outline-none focus:ring-0 border-none ${
                        darkMode ? "bg-gray-700" : "bg-white"
                      }`}
                      readOnly
                    />
                    <button className="p-2 rounded-r-lg border !rounded-button whitespace-nowrap cursor-pointer">
                      <FaPlus />
                    </button>
                  </div>
                </div>
