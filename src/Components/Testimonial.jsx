          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="rounded-xl p-8 bg-white shadow-lg dark:bg-gray-800">
              ...
              <p className="italic mb-4 text-gray-600 dark:text-gray-300">
                "আল ইফাদা দ্বারা প্রদত্ত সেবা অসাধারণ ছিল। ভিসা প্রক্রিয়াকরণ থেকে
            ...
            <div className="rounded-xl p-8 bg-white shadow-lg dark:bg-gray-800">
              ...
              <p className="italic mb-4 text-gray-600 dark:text-gray-300">
                "আমার উমরাহ অভিজ্ঞতা অসাধারণ ছিল। আল ইফাদা দ্বারা প্রদত্ত
            ...
            <div className="rounded-xl p-8 bg-white shadow-lg dark:bg-gray-800">
              ...
              <p className="italic mb-4 text-gray-600 dark:text-gray-300">
                "আল ইফাদা দ্বারা প্রদত্ত পরিষেবাগুলি আমার প্রত্যাশা ছাড়িয়ে গেছে।
